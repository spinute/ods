...
XXX: これ必要? % 「これ」とはhexadecimal numberのこと？python版だと特に説明なく0x表示になるようなので必要かと
\pcodeonly{
...
XXX: Rubyの整数の話をするか?　% YJ: Ruby独自の話はガンガンしていったほうが面白い本になるかと思います。輸出もしたいならなおさら。
...
\begin{thm}\thmlabel{prime-polynomial}
 ...
 % TODO XXX: YJ この定理正しいか？ xi in {0,1,2,..,p-1}ではなく xi in {1,2,..,p-1}？ 非自明にすべてを吸収されている気がする。要確認
